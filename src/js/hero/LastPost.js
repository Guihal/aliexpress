export function LastPost(data) {
	...
	const postImg = postData.hasOwnProperty("img") ? `<div class="hero__last-post_img-container"> <img class="hero__last-post_img" loading="lazy" alt="Крутое изображение поста" src="${postData.img}" /></div>` : "";
